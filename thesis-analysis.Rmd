...
# first, create a phyloseq-formatted metadata table (i.e. "sample data")
# note that need to give it a metadata with sample IDs as rownames, NOT an individual column, so we'll do that first
...
# diet observed vs mb shannon (and vice versa)
...
## compare observed and metabarcoding alpha diversity!
...
## ORIGINAL PLOTS (metabarcoding diet not focal diet) WITH ONLY THESE SAMPLES
...
# top 3 not observed - ASV10 (Morus lactea), ASV11, 15, 54, 110 (Hibiscus sp.), ASV16 (Laportea aestuans)
